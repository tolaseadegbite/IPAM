class FindFreeIps < RubyLLM::Tool
  description "Find truly free (unused) IP addresses in a subnet. Free IPs have no device assigned and no reachability activity."

  parameter :subnet_id, type: "integer", description: "The subnet ID to search for free IPs in"
